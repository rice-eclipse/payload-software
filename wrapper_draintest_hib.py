...
from main_system.components.DummyAltimeterReader import DummyHibAltimeterReader
...
config_path = './main_system/components/draintest_hib_config.json'
maincontroller = BigWrapper(config_path, DummyHibAltimeterReader, GyroscopeReader, AccelReader, TempReader)
