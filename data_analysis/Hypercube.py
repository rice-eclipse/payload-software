...
class Hypercube:
    def __init__(self, hypercube, wavebands):
        ...
        # Notes: The self.hypercube can be thought of as a stack of Numpy matrices.
        # The ith wavelength in self.wavebands (which is in nm) is the wavelength for the ith layer in self.hypercube
